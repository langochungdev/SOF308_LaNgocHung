...
const API = 'http://localhost:8080/asmvue/api/baiviet'
const BINHLUAN_API = 'http://localhost:8080/asmvue/api/binhluan'
const UPLOAD_API = 'http://localhost:8080/asmvue/api/upload'
...
export const getBinhLuanTheoBaiViet = async (maBaiViet) => {
    const res = await axios.get(`http://localhost:8080/asmvue/api/binhluan?maBaiViet=${maBaiViet}`)
    return res.data
}
